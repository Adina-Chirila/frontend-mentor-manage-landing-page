...
!(function (e) {
	...
	return (
		(t.init = function (e, t) {
			...
			var s,
				l = i.settingsBreakpoint();
			(t = t || l),
				("auto" !== i.opt.slidesToShow && void 0 === i.opt._autoSlide) ||
					((s = i.containerWidth / i.opt.itemWidth),
		...
		(t.updateControls = function (e) {
			...
			n.opt.rewind ||
				(n.arrows.prev &&
					...
					n.arrows.prev.classList.contains("disabled")
						? n.arrows.prev.setAttribute("aria-disabled", !0)
						: n.arrows.prev.setAttribute("aria-disabled", !1)),
				n.arrows.next &&
					...
					n.arrows.next.classList.contains("disabled")
						? n.arrows.next.setAttribute("aria-disabled", !0)
			...
			var a = n.slide + Math.floor(Math.floor(n.opt.slidesToShow) / 2),
			...
			1 === Math.floor(n.opt.slidesToShow) && (d = 0),
				...
				[].forEach.call(n.slides, function (e, t) {
					...
					s = Math.ceil(l) >= r && Math.floor(e) <= s;
					i.toggle("visible", s),
						s !== o &&
		...
		(t.scrollItem = function (e, t, i) {
			...
			return (
				...
				(e =
					!0 === t
						? ((e *= r.containerWidth),
						  Math.round(e / r.itemWidth) * r.itemWidth)
						: ("string" == typeof e &&
								((o = "prev" === e),
								(e =
									r.opt.slidesToScroll % 1 || r.opt.slidesToShow % 1
										? r.getCurrentSlide()
										: r.slide),
								o ? (e -= r.opt.slidesToScroll) : (e += r.opt.slidesToScroll),
								r.opt.rewind &&
									((i = r.ele.scrollLeft),
									(e =
										o && !i
											? r.slides.length
											: !o && i + r.containerWidth >= Math.floor(r.trackWidth)
											? 0
											: e))),
